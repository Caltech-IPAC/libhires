...
#  - Use "angle" value in Samples (currently assumed to be 0.0)
#  - Use "noise" value in Samples (currently assumed to be 1.0)
#  - Update code to increase speed
#  - Produce ancilary output files such as those output by YORIC (if desired)
#  - Do checking for errors/inconsistencies in user parameters and input data files
...
#====================================================================
    ...
    wgt_array += 0.0000001 # to avoid NaNs in results
    ...
    for filename in ( param_files ):
        for line in open(filename):
            ...
            if   name == 'SIZE_NPIX':
                ...
                if   boost_type == 'SQUARED': BOOST_FUNC = lambda x: x*x
