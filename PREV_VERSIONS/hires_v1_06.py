...
#====================================================================
    ...
    def __init__(self, detector_id, iFloat, jFloat, angle, flux, weight):
        ...
        bounds_in_image = self._compute_bounds_in_image(self.response_array, iWhole, jWhole)

        Footprint.i0min = min(Footprint.i0min, bounds_in_image[0])
        Footprint.i1max = max(Footprint.i1max, bounds_in_image[1])
        Footprint.j0min = min(Footprint.j0min, bounds_in_image[2])
        Footprint.j1max = max(Footprint.j1max, bounds_in_image[3])

        self.bounds_in_image = bounds_in_image
    ...
    #------------------------------------------------------------------------
    def _compute_bounds_in_image(self, full_reaponse_array, iWhole, jWhole):
...
#====================================================================
    ...
    all_footprints = [] ## 0=bounds_in_image, 1=array, 2=sum(array)  3=flux
...
#====================================================================
    ''' 1. Calculate padding adjustments to i,j bounds
        2. Apply to Footprint.bounds_in_image
    '''
    ...
    for foot in setOfFootprints:
        i0, i1, j0, j1 = foot.bounds_in_image
        new_bounds = (i0+delta_i, i1+delta_i, j0+delta_j, j1+delta_j)
        foot.bounds_in_image = new_bounds
...
#====================================================================
    ...
    log(1, 'detector: %d  file=%s radius= %d pixels = %f arcmin', \
