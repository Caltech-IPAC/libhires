...
#====================================================================
    ...
    def get_response_array(self, detector_id, iFloat, jFloat, angle):
        ...
        iFrac0 = iFloat % 1.0 # range:  0.0 <= frac < 1.0
        jFrac0 = jFloat % 1.0
        iFracID = int( iFrac0 * FOOTPRINTS_PER_PIX ) # range: 0 <= ID < FootPerPix
        jFracID = int( jFrac0 * FOOTPRINTS_PER_PIX )
        ...
        if footArr_key in Footprint.all_response_arrays:
            ...
            zero = (delta / 2.0 ) - 0.5
            iFrac = zero + iFracID * delta
            jFrac = zero + jFracID * delta
...
#====================================================================
    ...
    def function_interpolate(x, y): # interpolate in detector response array
        ...
        #@@ cheap "interpolation" -- really just takes nearest one
        iInt = int(iFloat+0.5)
        jInt = int(jFloat+0.5)
